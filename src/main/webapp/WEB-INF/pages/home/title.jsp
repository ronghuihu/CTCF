	...
	<div class="top_logo">
	    <div class="navMenu"  style="float:left;text-align:left;">
	    		...
	    		<div style="height:29px;">
			    	...
			    	<div id="mask">
<div id="menuContent">
	<shiro:hasPermission name="个人首页">
		<span id="topmenu" onclick="toModule('home');">个人首页</span><span id="tm_separator"></span>
	</shiro:hasPermission>
	<shiro:hasPermission name="城市风采">
		<span id="topmenu" onclick="#">城市风采</span><span id="tm_separator"></span>
	</shiro:hasPermission>
	<shiro:hasPermission name="地域文化">
		<span id="topmenu" onclick="toModule('areaculture');">地域文化</span><span id="tm_separator"></span>
	</shiro:hasPermission>
